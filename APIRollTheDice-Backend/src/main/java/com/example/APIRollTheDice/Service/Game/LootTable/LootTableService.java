package com.example.APIRollTheDice.Service.Game.LootTable;
...
import com.example.APIRollTheDice.Mapper.Game.LooTable.LootTableMapper;
...
public class LootTableService {
    ...
    public LootTable GetById(Long id){
        return lootTableInterface.findById(id).orElseThrow(() ->  new  NotFoundException("LootTable not found"));
    }
